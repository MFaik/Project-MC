...
all:
	g++ *.cpp -O3 -s -oExecutable/Game -DSFML_STATIC -I${sfmlincludedir}  -L${sfmllibdir} $(sfmllib) ${externallib}

debug:
	g++ *.cpp -O1 -g -oExecutable/Game -DSFML_STATIC -I ${sfmlincludedir} -L ${sfmllibdir} $(sfmllibd) ${externallib}
